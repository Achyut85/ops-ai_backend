...
export type StorageHash =
  StorageHashBase<'dfd102f7ed4f78a97ca3a8bb151c8852459f02ccb73e2e611c8473ec027360c6'>;
export type ExecutionHash =
  ExecutionHashBase<'24941c1c510e186fb4381dc5525fa04c1df2ab75551ceb439658b166487381da'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Ticket: {
      ...
      readonly organizationId: CodecTypes['pg/int4@1']['output'];
      readonly assignedUserId: CodecTypes['pg/int4@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Ticket: {
      ...
      readonly organizationId: CodecTypes['pg/int4@1']['input'];
      readonly assignedUserId: CodecTypes['pg/int4@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'organizationAccount';
                    readonly columns: readonly ['organizationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly ticket: {
              ...
              indexes: readonly [
                {
                  readonly name: 'ticket_organizationId_idx_2e17ef41';
                  readonly prefix: 'ticket_organizationId_idx';
                  readonly columns: readonly ['organizationId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'ticket_assignedUserId_idx_d0c6c9aa';
                  readonly prefix: 'ticket_assignedUserId_idx';
            ...
            readonly ticketHistory: {
              ...
              indexes: readonly [
                {
                  readonly name: 'ticketHistory_organizationId_idx_2e17ef41';
                  readonly prefix: 'ticketHistory_organizationId_idx';
                  readonly columns: readonly ['organizationId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'ticketHistory_ticketId_idx_2fe526c3';
                  readonly prefix: 'ticketHistory_ticketId_idx';
                  readonly columns: readonly ['ticketId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'ticketHistory_userId_idx_a489d58a';
                  readonly prefix: 'ticketHistory_userId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'ticketHistory';
                    readonly columns: readonly ['organizationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly user: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['organizationId', 'username'] }];
              indexes: readonly [
                {
      ...
      readonly public: {
        readonly models: {
          ...
          readonly OrganizationAccount: {
            ...
            readonly storage: {
              readonly table: 'organizationAccount';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
